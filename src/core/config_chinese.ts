...
export const AI_TOOLS_CHINESE: AIToolChineseOption[] = [
  ...
  { name: 'Antigravity', value: 'antigravity', available: true, successLabel: 'Antigravity', chineseName: 'Antigravity' },
  ...
  { name: 'Continue', value: 'continue', available: true, successLabel: 'Continue', chineseName: 'Continue 开发助手' },
  ...
  { name: 'iFlow', value: 'iflow', available: true, successLabel: 'iFlow', chineseName: 'iFlow' },
  { name: 'Kiro', value: 'kiro', available: true, successLabel: 'Kiro', chineseName: 'Kiro' },
  ...
  { name: 'Qoder', value: 'qoder', available: true, successLabel: 'Qoder', chineseName: 'Qoder编码助手' },
  { name: 'Windsurf', value: 'windsurf', available: true, successLabel: 'Windsurf', chineseName: 'Windsurf冲浪编程' },
  { name: 'Trae', value: 'trae', available: true, successLabel: 'Trae', chineseName: 'Trae' },
